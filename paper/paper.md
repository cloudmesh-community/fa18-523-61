...
Another challenge is Natural Language Understanding (NLU). NLU pertains to the ability of a computer to comprehend the sentence structure and intended meaning of human languages, which in turn allows humans to fully communicate and interact with machines using real sentences [@www-gartner]. This concept is gained interest in recent years due to the many possible ways this can be leveraged within applications on a commercial scale.  
